<template>
  <div>
    <div class="test2" v-if="message" v-for="a in message">{{ a }}</div>
    <img class="test" v-if="imgsrc" :src="imgsrc" />
  </div>
</template>
...
.test {
  animation: falling 5s 30s forwards;
}
.test2 {
  animation: fallingLeaves 7s 40s forwards;
}
